...
import useIsMounted from '@/hooks/use-is-mouned'
      ...
      <CardContent className='p-4'>
        {!isAddressSelected && (
          <div className='border-b mb-4'>
            <Button
              className='rounded-full w-full cursor-pointer hover:bg-amber-200'
        ...
        {isAddressSelected && !isPaymentMethodSelected && (
          <div className=' mb-4'>
            <Button
              className='rounded-4xl  w-full cursor-pointer hover:bg-green-400'
        ...
        {isPaymentMethodSelected && isAddressSelected && (
          <div>
            <Button onClick={handlePlaceOrder} className='rounded-full w-full cursor-pointer hover:bg-amber-200'>
              Place Your Order
            </Button>
            <p className='text-xs text-center py-2'>
                  ...
                  >
                    <Card className='md:ml-8 my-4'>
                      ...
                      <CardFooter className='  p-4'>
                        <Button
                          type='submit'
                          className='rounded-full font-bold cursor-pointer hover:bg-amber-200'
                        >
                          Ship to this address
                        </Button>
                      </CardFooter>
          ...
          <div className='border-y'>
            {isPaymentMethodSelected && paymentMethod ? (
              <div className='grid  grid-cols-1 md:grid-cols-12  my-3 pb-3 '>
                ...
                <div className='col-span-5 cursor-pointer hover:text-amber-500'>
                  <p>{paymentMethod}</p>
                </div>
                <div className='col-span-2'>
                  <Button
              ...
              <>
                <div className='flex text-dark text-lg font-bold my-2'>
                    ...
                    >
                      {AVAILABLE_PAYMENT_METHODS.map((pm) => (
                        <div key={pm.name} className='flex items-center py-1 '>
                          ...
                          />
                          <Label
                            className='font-bold pl-2 cursor-pointer hover:text-amber-400'
            ...
            <div className='mt-6'>
              ...
              <Card className='hidden md:block '>
                <CardContent className='p-4 flex flex-col md:flex-row justify-between items-center gap-3'>
                  <Button onClick={handlePlaceOrder} className='rounded-full cursor-pointer hover:bg-amber-200'>
                    Place Your Order
                  </Button>
                  <div className='flex-1'>
